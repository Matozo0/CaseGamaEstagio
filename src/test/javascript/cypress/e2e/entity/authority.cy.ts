...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '3cc4cc1d-a113-4bbf-aed5-787b0c4088a6' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('203d7ce1-6912-40b2-81ed-5e0e58167c3f');
      cy.get(`[data-cy="name"]`).should('have.value', '203d7ce1-6912-40b2-81ed-5e0e58167c3f');
