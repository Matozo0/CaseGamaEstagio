...
/**
 * REST controller for managing {@link com.gamaestagio.app.domain.Aluno}.
 */
@RestController
        ...
        Optional<Aluno> result = alunoRepository
            ...
            .map(existingAluno -> {
                ...
                if (aluno.getSerie() != null) {
                    existingAluno.setSerie(aluno.getSerie());
                }
                if (aluno.getJaFezEnem() != null) {
                    existingAluno.setJaFezEnem(aluno.getJaFezEnem());
                }
                if (aluno.getFaculdadePreferida() != null) {
                    existingAluno.setFaculdadePreferida(aluno.getFaculdadePreferida());
                }
                if (aluno.getCursoPreferido() != null) {
                    existingAluno.setCursoPreferido(aluno.getCursoPreferido());
                }
